                        ...
                        {props.launchYear.map((year, key) => {
                            return (
                                <Col className="filterYear" key={key}>
                                    <Button
                                        className={props.selectedLaunchYear === year ? 'selected' : ''}
    ...
    const createCard = (data) => {
        return (
            data && data.map((item, key) => {
                let missionIds = item.mission_id.length ? item.mission_id.map(id => id) : '-'
